...
const LeftSidebar = () => {
    const messageRequests = [
        {
            name: 'John Doe',
            message: "Hey, I'd like to connect with you!"
        },
        {
            name: 'Jane Smith',
    ...
    return (
        <div className="sidebar p-1">
            ...
            <p className="mb-4">This section displays message requests from new profiles.</p>
                ...
                {messageRequests.map((request, index) => (
                    <div key={index} className="bg-white p-4 rounded shadow">
                        ...
                        <div className="flex justify-end">
                            ...
                            <button className="px-4 py-2 bg-red-500 text-white rounded ml-2">Decline</button>
                        </div>
                    </div>
                ))}
            </div>
